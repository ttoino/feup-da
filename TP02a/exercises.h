...
public:
     ...
     * Throws an IllegalArgumentException if any cell has a value out of range
     * or a number is repeated in the same line, column or 3x3 block.
     *
     ...
     *   >1 if the puzzle has two or more solutions (for efficiency reasnos, it
     * does not count all of the solutions and stops on the second one)
     */
    int countSolutions();
    /**
     * Generates a puzzle with a unique solution and filled with as least cells
     * as possible that ensure that the solution is unique.
     */
    void generate();
    /**
